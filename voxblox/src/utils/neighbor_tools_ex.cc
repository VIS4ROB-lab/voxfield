...
// clang-format off
const Neighborhood24LookupTables::Distances Neighborhood24LookupTables::kDistances = [] { // NOLINT
...
const Neighborhood24LookupTables::IndexOffsets Neighborhood24LookupTables::kOffsets = [] { // NOLINT
...
const Neighborhood24LookupTables::LongIndexOffsets Neighborhood24LookupTables::kLongOffsets = [] { // NOLINT
